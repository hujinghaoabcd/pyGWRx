...
| SGWR | Lessani & Li (2024), DOI [`10.1080/13658816.2024.2342319`](https://doi.org/10.1080/13658816.2024.2342319) | Convex combination of geographic and attribute-similarity weights; training-based similarity standardisation; AICc alpha selection. | **Evidence-reviewed manual complete.** |
| SGTWR | Li et al. (2025), DOI [`10.3390/su172310773`](https://doi.org/10.3390/su172310773) | Space-time Gaussian component plus SGWR similarity component; deterministic AICc candidate search replaces the paper's genetic algorithm. | **Evidence-reviewed manual complete.** |
